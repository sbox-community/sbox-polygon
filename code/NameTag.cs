...
/// </summary>
internal class NameTagComponent : EntityComponent<PolygonPlayer>
{
    NameTag NameTag;
    ...
    {
        foreach (var player in Sandbox.Entity.All.OfType<PolygonPlayer>())
        {
