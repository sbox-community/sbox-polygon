...
public partial class BaseCarryable : Component
{
	...
	/// </summary>
	public PolygonPlayer Owner
	{
		get
		{

			return Components != null ? GetComponentInParent<PolygonPlayer>( true ) : null; //Fixed
		}
	}
	...
	public virtual void OnAdded( PolygonPlayer player )
	{
		// nothing
	}
	...
	/// </summary>
	public virtual void OnEquipped( PolygonPlayer player )
	{
	...
	/// </summary>
	public virtual void OnHolstered( PolygonPlayer player )
	{
	...
	/// </summary>
	public virtual void OnFrameUpdate( PolygonPlayer player )
	{
	...
	/// </summary>
	public virtual void OnPlayerUpdate( PolygonPlayer player )
	{
		if ( IsProxy )
			return;
	...
	/// </summary>
	/// <param name="player"></param>
	public virtual void OnControl( PolygonPlayer player )
	{
	}
	...
	public virtual void OnCameraSetup( PolygonPlayer player, Sandbox.CameraComponent camera )
	{
	}
	...
	public virtual void OnCameraMove( PolygonPlayer player, ref Angles angles )
	{
	}
